...
contract UniswapV3Pool is IUniswapV3Pool, NoDelegateCall {
    ...
    function mint(
        ...
        // console.log("liquidity amount", amount);
        emit Mint(
            msg.sender,
            recipient,
            tickLower,
    ...
    function burn(
        ...
        // console.log("burn amount from the contract", amount);
        // console.log("burn amount0 from the contract", amount0);
        // console.log("burn amount1 from the contract", amount1);
        ...
        returns (int256 amount0, int256 amount1)
    {
        ...
        // console.log("swap amount0", uint256(amount0 * -1));
        // console.log("swap amount1", uint256(amount1));
        // console.log("swap amount1", state.sqrtPriceX96);
        // console.log("swap amount1", uint24(state.tick));
