...
describe("TwapStrategyManager", () => {
  ...
  describe("#grantRole", async () => {
    it("should revert if not called by manager", async () => {
      ...
      await expect(strategyManager.connect(signers[1]).grantRole(userWhiteListRole, signers[2].address)).to.be.revertedWith(
  ...
  describe("#revokeRole", async () => {
    it("should revert if not called by manager", async () => {
      ...
      await expect(strategyManager.connect(signers[1]).revokeRole(userWhiteListRole, signers[2].address)).to.be.revertedWith(
  ...
  describe("#changeManagementFeeRate", async () => {
    it("should revert if operator is not calling", async () => {
      await expect(strategyManager.connect(signers[1]).changeManagementFeeRate(1)).to.be.revertedWith("N")
    })
  ...
  describe("#changePerformanceFeeRate", async () => {
    it("should revert if operator is not calling", async () => {
      await expect(strategyManager.connect(signers[1]).changePerformanceFeeRate(1)).to.be.revertedWith("N")
    })
